 ...
 */
export declare class ScrollMetricsManager extends Blockly.MetricsManager {
    /**
     ...
     */
    contentMetrics: Blockly.MetricsManager.ContainerRegion | null;
    /** @override */
    getContentMetrics(): Blockly.MetricsManager.ContainerRegion;
}
/**
 ...
 */
export declare function isCacheable(metricsManager: Blockly.IMetricsManager): metricsManager is CacheableMetricsManager;
//# sourceMappingURL=ScrollMetricsManager.d.ts.map